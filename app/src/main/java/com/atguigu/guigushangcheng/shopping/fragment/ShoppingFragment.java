...
import com.atguigu.guigushangcheng.shopping.utils.PayResult;
import com.atguigu.guigushangcheng.shopping.utils.SignUtils;
...
public class ShoppingFragment extends BaseFragment {
    ...
    private void hideDelete() {
        ...
        if(shoppingCartAdapter != null){
            shoppingCartAdapter.check_none(true);
    ...
    private void showDelete() {
        ...
        //5.把所有的数据设置非选择状态
        if(shoppingCartAdapter != null){
            shoppingCartAdapter.check_none(false);
            shoppingCartAdapter.checkAll();
            shoppingCartAdapter.showTotalPrice();
        }
    }
